  ...
  return (
    <nav className="fixed top-2 md:top-4 left-0 right-0 z-50 px-2 md:px-4">
      <div className="container mx-auto max-w-7xl">
        {/* Thinner Navbar: h-12 on mobile, h-14 on desktop */}
        <div className="bg-white/95 backdrop-blur-md border border-white/20 rounded-xl md:rounded-2xl shadow-xl h-12 md:h-14 flex items-center justify-between px-3 md:px-6">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/requests" className="text-xs font-bold text-gray-600 hover:text-primary transition-colors">সাহায্য খুঁজুন</Link>
            <Link href="/volunteer" className="text-xs font-bold text-gray-600 hover:text-primary transition-colors">স্বেচ্ছাসেবক</Link>
            <Link href="/about" className="text-xs font-bold text-gray-600 hover:text-primary transition-colors">আমাদের লক্ষ্য</Link>
          </div>
              ...
              <SheetContent side="right" className="w-[280px] bg-white border-l-0 rounded-l-3xl p-0 overflow-hidden">
                <div className="h-full flex flex-col bg-gradient-to-b from-white to-gray-50">
                  ...
                  <div className="flex-grow p-6 space-y-2">
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-4">মেনু</p>
                    <Link href="/requests" className="flex items-center gap-3 p-3 rounded-xl hover:bg-primary/5 text-gray-700 font-bold transition-all">
                      <Globe className="h-4 w-4 text-primary" /> সাহায্য খুঁজুন
                    </Link>
                    <Link href="/volunteer" className="flex items-center gap-3 p-3 rounded-xl hover:bg-primary/5 text-gray-700 font-bold transition-all">
                      <User className="h-4 w-4 text-primary" /> স্বেচ্ছাসেবক হন
                    </Link>
                    <Link href="/about" className="flex items-center gap-3 p-3 rounded-xl hover:bg-primary/5 text-gray-700 font-bold transition-all">
                      <Heart className="h-4 w-4 text-primary" /> আমাদের লক্ষ্য
                    </Link>
                  </div>
                  ...
                  <div className="p-6 bg-white border-t border-gray-100 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <Button variant="outline" className="rounded-xl font-bold h-10 text-xs gap-2">
                        <LogIn className="h-3 w-3" /> লগ ইন
                      </Button>
                      <Button className="rounded-xl font-bold h-10 text-xs gap-2 bg-primary">
                        <UserPlus className="h-3 w-3" /> সাইন আপ
                      </Button>
                    </div>
                  </div>
                </div>
