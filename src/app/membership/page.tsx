...
import { UserCheck, ShieldCheck, Award, Briefcase, FileText, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen flex flex-col bg-[#0a0a0a]">
      ...
      <main className="container mx-auto px-4 py-32 flex-grow max-w-6xl">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-lg text-white/40 max-w-2xl mx-auto">ওঙ্গন বাংলাদেশের গর্বিত সদস্য হয়ে মানবিক লক্ষ্য অর্জনে সরাসরি ভূমিকা রাখুন।</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          
          <div className="lg:col-span-5 space-y-8">
            <h2 className="text-2xl font-bold text-white">কেন সদস্য হবেন?</h2>
            <div className="grid gap-6">
              {[
                ...
                <Card key={i} className="bg-white/5 border-white/5 rounded-3xl p-6 hover:bg-white/10 transition-all">
                  <div className="flex gap-4">
                    <div className="p-3 rounded-2xl bg-primary/20 text-primary h-fit">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input placeholder="যেমন: শিক্ষক, ডাক্তার" className="bg-white/5 border-white/10 text-white h-14 rounded-2xl" required />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-white/60 text-[10px] font-bold uppercase tracking-widest">মোবাইল নম্বর</Label>
                      <Input placeholder="01XXX-XXXXXX" className="bg-white/5 border-white/10 text-white h-14 rounded-2xl" required />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label className="text-white/60 text-[10px] font-bold uppercase tracking-widest">বর্তমান ঠিকানা</Label>
                    <Input placeholder="পুরো ঠিকানা লিখুন" className="bg-white/5 border-white/10 text-white h-14 rounded-2xl" required />
                  </div>
                  ...
                  <Button 
                    ...
                    className="w-full h-16 bg-white text-primary hover:bg-white/90 font-bold text-lg rounded-2xl shadow-xl transition-all"
                  >
