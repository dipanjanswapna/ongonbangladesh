          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4 items-start p-4 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all">
            ...
            <CardContent className="p-8 space-y-8">
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="space-y-4">
                  ...
                  <RadioGroup defaultValue="monthly" onValueChange={setInterval} className="grid grid-cols-2 gap-4">
                    <div className="relative">
                      ...
                      <Label htmlFor="monthly" className="flex flex-col items-center justify-center rounded-2xl border-2 border-white/5 bg-white/5 p-4 text-white hover:bg-white/10 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/10 cursor-pointer transition-all">
                        <span className="text-sm font-bold">মাসিক</span>
                      </Label>
                    </div>
                    <div className="relative">
                      <RadioGroupItem value="yearly" id="yearly" className="peer sr-only" />
                      <Label htmlFor="yearly" className="flex flex-col items-center justify-center rounded-2xl border-2 border-white/5 bg-white/5 p-4 text-white hover:bg-white/10 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/10 cursor-pointer transition-all">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['500', '1000', '2000'].map((amt) => (
                      <Button 
                        ...
                        type="button"
                        variant="outline"
                        className={`h-12 rounded-xl border-white/10 text-white font-bold hover:bg-white hover:text-primary ${amount === amt ? 'bg-white text-primary shadow-lg' : 'bg-white/5'}`}
                  ...
                  <div className="relative">
                    ...
                    <Input 
                      ...
                      className="bg-white/5 border-white/10 text-white pl-10 h-14 rounded-2xl focus:ring-primary/40"
                    />
                  </div>
                </div>
                ...
                <Button 
                  ...
                  className="w-full h-16 bg-white text-primary hover:bg-white/90 font-bold text-lg rounded-2xl shadow-xl transition-all active:scale-95 flex items-center justify-center gap-2"
                >
