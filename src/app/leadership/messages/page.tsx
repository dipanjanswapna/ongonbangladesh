      ...
      <main className="container mx-auto px-4 py-32 flex-grow max-w-5xl">
        ...
        <div className="space-y-12">
          {leadershipMessages.map((leader, i) => (
            <Card key={i} className="bg-white/5 border-white/10 rounded-[3rem] overflow-hidden shadow-2xl backdrop-blur-xl">
              <CardContent className="p-8 md:p-12">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                  <div className="md:col-span-4 flex flex-col items-center text-center space-y-4">
                    <div className="relative h-56 w-56 rounded-[2.5rem] overflow-hidden border-4 border-white/10 shadow-2xl transition-transform duration-500 hover:scale-105">
                      <Image 
                        src={leader.image} 
                        alt={leader.name} 
                        fill 
